...
import './managerCss/managerHeader.css';
...
function ManagerHeader({dashBoardOpen}){
    ...
    return(
        <>
            <div className="manager_banner" >
            <Link to={"/"}  className="userPageLink"> 사용자 페이지로 돌아가기</Link>
            <div className="manager_login"><Button style={{color:'white'}}onClick={loginBtnHandler}>log-Out</Button></div>

            ...
            <div className="detail_wapper">
                ...
                <div className="detail_category">
                    ...
                    <div className="detail_button">
                        <button className='update_button2' onClick={() => productUpdateOptionOpen()}>상품 수정하기</button>
                        <button className='update_button2' onClick={() => productDelete(products.product[0].product_id)}>상품 삭제하기</button>
                    </div>
                </div>
            </div>
        </>

        ...
        <Div style={{textAlign:'center', minHeight:'110%'}}>
            ...
            <Table style={{marginBottom:'20px', marginTop:'40px'}}> 
                ...
                <TableRow>
                    ...
                    <TableCell align="center">{user_birthday}</TableCell>
                </TableRow>
                <TableRow>
                    <TableCell align="center">아이디/이메일</TableCell>
            ...
            <p style={{fontSize:'14px', color:'gray', textAlign:'left'}}>비밀번호 찾기에 더 궁금하신 사항이 있다면 고객센터에 문의 주세요.</p>
            </div>
            <Footer/>
        </Div>
    )

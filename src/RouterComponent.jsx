...
import CustomerChat from './Chatcomponent/CustomerChat';
import ManagerChat from './Chatcomponent/ManagerChat';
    ...
    return(
        <div style={style} >
                    <Switch >
                        ...
                        {/*채팅 페이지*/}
                        <Route exact path="/chat/customer" component={CustomerChat}/>
                        <Route exact path="/chat/manager" component={ManagerChat}/>
                        <Route path="/chat/:toEmail" component={ChatComponent}/>

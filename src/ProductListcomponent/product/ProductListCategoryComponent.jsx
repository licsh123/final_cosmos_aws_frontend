                ...
                <Grid item xs={12}> 
                    ...
                    <div style={{float:'left'}}>
                        <ul style={{paddingLeft:'0px', marginTop:'0px'}}>
                            <SelectOptionComponenttest selectOption={selectOption} label="Style" name="product_category" items={['아우터','티셔츠','셔츠','원피스','바지','치마','모자','신발']}/>

                            <SelectOptionComponenttest selectOption={selectOption} label="Color" name="select_color" items={['BLACK','GRAY','SILVER','RED','WHITE','BLUE','GOLD','YELLOW']}/>
